    ...
    <div class="wrap imco-modern-admin">
        ...
        <div class="imco-modern-card">
            ...
            <form method="post">
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">
                                <label
                                    for="imco_cat_option_columns"><?php esc_html_e('Columnas de variaciones', 'imco-filter'); ?></label>
                            </th>
                            <td>
                ...
                <p class="submit">
                    ...
                    <?php if ($editing_data): ?>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=imco-attribute-categories')); ?>"
                            class="button" style="margin-left: 10px; border-radius: 8px;">Cancelar</a>
                    <?php endif; ?>
                </p>
            </form>
        </div>
        ...
        <div class="imco-modern-card" style="padding: 0; overflow: hidden; border: none; box-shadow: none;">
            <h2
                ...
                <?php esc_html_e('Categorías de atributos existentes', 'imco-filter'); ?></h2>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width: 150px; text-align: right; padding-right: 24px;">
                            <?php esc_html_e('Acciones', 'imco-filter'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($categories as $cat): ?>
                            <tr>
                                ...
                                <td class="row-actions" style="text-align: right; padding-right: 24px;">
                                    <?php
                                    ...
                                    ?>
                                    <a
                                        href="<?php echo esc_url($edit_url); ?>"><?php esc_html_e('Editar', 'imco-filter'); ?></a>
                                    &nbsp;|&nbsp;
