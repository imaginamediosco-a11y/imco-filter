    ...
    function imcoInitMobileAccordion() {
        ...
        function applyMobileCollapse() {
            if (window.innerWidth <= 768) {
                $groups.addClass('imco-collapsed');
            } else {
                $groups.removeClass('imco-collapsed');
            }
        }
        ...
        // Aplicar al redimensionar la ventana
        var resizeTimer;
        ...
        // Event delegation para soportar elementos recargados por AJAX
        $(document).on('click', '.imco-filter-archive .imco-filter-title', function (e) {
            if (window.innerWidth <= 768) {
                e.preventDefault();
                $(this).closest('.imco-filter-group').toggleClass('imco-collapsed');
            }
        });
    }
